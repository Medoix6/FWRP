...
"[project]/node_modules/@cloudinary/react/dist/index.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
 ...
 */ var objectToString = objectProto.toString;
    ...
    /** Built-in value references. */ var Buffer = moduleExports ? root.Buffer : undefined, Symbol1 = root.Symbol, Uint8Array = root.Uint8Array, getPrototype = overArg(Object.getPrototypeOf, Object), objectCreate = Object.create, propertyIsEnumerable = objectProto.propertyIsEnumerable, splice = arrayProto.splice;
    ...
    /* Built-in method references that are verified to be native. */ var DataView = getNative(root, 'DataView'), Map1 = getNative(root, 'Map'), Promise1 = getNative(root, 'Promise'), Set = getNative(root, 'Set'), WeakMap = getNative(root, 'WeakMap'), nativeCreate = getNative(Object, 'create');
    /** Used to detect maps, sets, and weakmaps. */ var dataViewCtorString = toSource(DataView), mapCtorString = toSource(Map1), promiseCtorString = toSource(Promise1), setCtorString = toSource(Set), weakMapCtorString = toSource(WeakMap);
 ...
 */ var getTag = baseGetTag;
    ...
    if (DataView && getTag(new DataView(new ArrayBuffer(1))) != dataViewTag || Map1 && getTag(new Map1) != mapTag || Promise1 && getTag(Promise1.resolve()) != promiseTag || Set && getTag(new Set) != setTag || WeakMap && getTag(new WeakMap) != weakMapTag) {
        ...
        return __generator(this, function(_a) {
            switch(_a.label){
                ...
                case 1:
                    ...
                    return [
                        4 /*yield*/ ,
                        plugins[i](element, pluginCloudinaryAsset, pluginState, analyticsOptions, plugins)
                    ];
                case 2:
                    response = _a.sent();
 ...
 */ class AssistColorBlindEffectAction extends Action {
     ...
     */ xray() {
        ...
        return this.addQualifier(new Qualifier('e', new QualifierValue([
            'assist_colorblind',
            'xray'
        ]).setDelimiter(':')));
    }
 ...
 */ var BLUR = new Transformation().effect(blur(2000)).delivery(quality('auto')).delivery(format(auto$1()));
/**
...
function serverSideSrc(plugins, serverCloudinaryImage, analyticsOptions) {
    ...
    return clonedServerCloudinaryImage.toURL(analyticsOptions ? {
        trackedAnalytics: analyticsOptions
    } : null);
}
/**
...
var SDKAnalyticsConstants = {
    sdkSemver: '1.14.3',
    techVersion: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].version,
    sdkCode: 'J'
};
/**
 * @mixin ReactSDK
 ...
 */ var AdvancedImage = function(_super) {
    __extends(AdvancedImage, _super);
    function AdvancedImage(props) {
        var _this = _super.call(this, props) || this;
        _this.imageRef = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].createRef();
        return _this;
    }
    /**
    ...
    AdvancedImage.prototype.render = function() {
        ...
        var otherProps = __rest(_a, [
            "cldImg",
            "plugins"
        ]) // Assume any other props are for the base element
        ;
        if (isBrowser()) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].createElement("img", __assign({
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].createElement("img", __assign({}, otherProps, {
                src: src
            }));
        }
    };
 ...
 */ var AdvancedVideo = function(_super) {
    ...
    AdvancedVideo.prototype.render = function() {
        ...
        ;
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].createElement("video", __assign({}, videoAttrs, {
            ref: this.attachRef
        }));
    };
...
//# sourceMappingURL=node_modules_%40cloudinary_react_dist_index_14e0c4.js.map