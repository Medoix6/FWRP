...
"[project]/src/app/complete-profile/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function CompleteProfile() {
    ...
    const handleSubmit = async (event)=>{
        ...
        try {
            const user = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$firebase$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["auth"].currentUser;
            if (!user) {
                alert("No authenticated user found. Please log in again.");
                return;
            }
            // Save profile data to Firestore under users/{uid}
            await setDoc(doc(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$firebase$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"], "users", user.uid), {
                name: formData.name,
...
"[project]/src/app/complete-profile/page.tsx [app-rsc] (ecmascript, Next.js server component, client modules ssr)": ((__turbopack_context__) => {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__3bd53f._.js.map